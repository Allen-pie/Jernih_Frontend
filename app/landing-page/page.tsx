...
export default function HomePage() {
  ...
  const heroUrl = useHeroImage("landing-page.jpeg");
      ...
      <section className="relative w-full min-h-screen flex items-center pt-16">
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-5xl font-bold text-cyan-600 mb-6">
              Monitor Water Quality in Real-Time. Take Action Today
            </h1>
            <p className="text-cyan-600 text-lg mb-8">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button variant="ghost" className="px-6 py-6 rounded-md">
                Explore Our Data <span className="ml-2">→</span>
              </Button>
            </div>
          </div>
        </div>
